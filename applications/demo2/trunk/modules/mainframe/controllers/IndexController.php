...
class Mainframe_IndexController extends Core_Library_Controller_MainFrame_Index
{
        public function init()
        {
                ...
                $themes = explode( ",", "android,arctic,black,blackberry,bootstrap,energyblue,fresh,highcontrast,metro,metrodark,mobile,office,orange,shinyblack,summer,web,windowsphone" ) ;
                foreach( $themes as $theme ) {
                        $this->view->headLink()->prependStylesheet( $sGridUrl . 'styles/jqx.' . $theme . '.css' ) ;
                }
                $this->view->headLink()->prependStylesheet( $sGridUrl . 'styles/jqx.base.css' ) ;
                // !!! jquery-1.10.2.min.js est chargé par Bootstrap dans le noyau !!!
